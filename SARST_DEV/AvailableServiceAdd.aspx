<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AvailableServiceAdd.aspx.cs" Inherits="SARST_DEV.AvailableServiceAdd" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h1 style="text-align:center;">Add an Available Service</h1>
    <p style="text-align:center;">Create a new AvailableService which will be available to residents and the AvailableService to the database.</p>
