<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ResidentEdit.aspx.cs" Inherits="SARST_DEV.ResidentEdit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h1 style="text-align:center;">Edit Resident Information</h1>
    <p style="text-align:center;">Enter the resident's information below and click submit to update the resident's information in the database. Please note that all changes are final and cannot be undone.</p>
